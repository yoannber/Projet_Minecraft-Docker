...
- *Dockercraft* : un ajout qui permet d'administrer les conteneurs Docker dans le monde Minecraft (il faut une version Minecraft inférieure à la 1.12.2) - attention à ne pas donner l'accès à ce serveur à n'importe qui car le serveur possède les accès root sur la machine hôte
