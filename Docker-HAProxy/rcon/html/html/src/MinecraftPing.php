...
class MinecraftPing
{
	...
	public function __construct( $Address, $Port = 25566, $Timeout = 2, $ResolveSRV = true )
	{
	...
	public function QueryOldPre17( )
	{
		...
		if( $Data[ 1 ] === "\xA7" && $Data[ 2 ] === "\x31" )
		{
			...
			return Array(
				'Nom de l\'hôte'   => $Data[ 3 ],
				'Joueurs'    => IntVal( $Data[ 4 ] ),
				'Nombre maximum de joueurs' => IntVal( $Data[ 5 ] ),
